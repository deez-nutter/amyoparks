-- Simple missing tables for immediate admin functionality
-- This creates the basic tables needed for the admin to work

-- Add missing columns to existing parks table
ALTER TABLE `parks` 
...
-- Create simple amenities table for admin functionality
